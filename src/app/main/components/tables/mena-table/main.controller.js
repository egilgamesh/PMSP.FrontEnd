(function ()
{
  ...
  angular.module('app.components.tables.MENA')
        .controller('MENAController', MainController);

    /** @ngInject */
    function MainController($http, $scope, $MENAFormAPI, $MENASearchFormAPI, $mdDialog, appConfig, $state, $stateParams, $timeout, $q, $log)
    {
      var folderPath = 'app/main/components/tables/mena-table/';
      var vm = this;
      ...
      $http.get(appConfig.apiUrl + 'MENAFiltersItems').then(function (response) {
      ...
      vm.addItem = function (event) {
        console.log(event);
        $state.go('app.ui_forms-MENATool');
      };

      vm.delete = function (event) {
        $mdDialog.show({
          clickOutsideToClose: true,
          controller: 'DelMENAAPIController',
          controllerAs: 'ctrl',
          focusOnOpen: false,
          targetEvent: event,
      ...
      vm.getItems= function () {
        ...
        vm.promise = $MENAFormAPI.items.get(vm.query, success).$promise;
      };
      ...
      function querySearch (query) {
        ...
        $http.get(appConfig.apiUrl + 'SearchMENAForm/' + finalQuery)
      ...
      $scope.loadGroups = function () {
        ...
        return $scope.searchItems.length ? null : $http.get(appConfig.apiUrl + 'getItemsForAdvanceSearchMENA').then(function (data) {
