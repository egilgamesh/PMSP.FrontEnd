(function ()
{
  ...
  angular.module('app.components.tables.IOM')
        .controller('IOMController', MainController);

    /** @ngInject */
    function MainController($http, $scope, $IOMFormAPI, $IOMSearchFormAPI, $mdDialog, appConfig, $state, $stateParams, $timeout, $q, $log)
    {
      var folderPath = 'app/main/components/tables/iom-table/';
      var vm = this;
      ...
      $http.get(appConfig.apiUrl + 'IOMFiltersItems').then(function (response) {
      ...
      vm.addItem = function (event) {
        console.log(event);
        $state.go('app.ui_forms-IOMTool');
      };

      vm.delete = function (event) {
        $mdDialog.show({
          clickOutsideToClose: true,
          controller: 'DelIOMAPIController',
          controllerAs: 'ctrl',
          focusOnOpen: false,
          targetEvent: event,
      ...
      vm.getItems= function () {
        ...
        vm.promise = $IOMFormAPI.items.get(vm.query, success).$promise;
      };
      ...
      function querySearch (query) {
        ...
        $http.get(appConfig.apiUrl + 'SearchIOMForm/' + finalQuery)
      ...
      $scope.loadGroups = function () {
        ...
        return $scope.searchItems.length ? null : $http.get(appConfig.apiUrl + 'getItemsForAdvanceSearchIOM').then(function (data) {
