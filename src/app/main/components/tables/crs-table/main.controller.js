(function ()
{
  ...
  angular.module('app.components.tables.CRS')
        .controller('CRSController', MainController);

    /** @ngInject */
    function MainController($http, $scope, $CRSFormAPI, $CRSSearchFormAPI, $mdDialog, appConfig, $state, $stateParams, $timeout, $q, $log)
    {
      var folderPath = 'app/main/components/tables/crs-table/';
      var vm = this;
      ...
      $http.get(appConfig.apiUrl + 'CRSFiltersItems').then(function (response) {
      ...
      vm.addItem = function (event) {
        console.log(event);
        $state.go('app.ui_forms-CRSTool');
      };

      vm.delete = function (event) {
        $mdDialog.show({
          clickOutsideToClose: true,
          controller: 'DelCRSAPIController',
          controllerAs: 'ctrl',
          focusOnOpen: false,
          targetEvent: event,
      ...
      vm.getItems= function () {
        ...
        vm.promise = $CRSFormAPI.items.get(vm.query, success).$promise;
      };
      ...
      function querySearch (query) {
        ...
        $http.get(appConfig.apiUrl + 'SearchCRSForm/' + finalQuery)
      ...
      $scope.loadGroups = function () {
        ...
        return $scope.searchItems.length ? null : $http.get(appConfig.apiUrl + 'getItemsForAdvanceSearchCRS').then(function (data) {
