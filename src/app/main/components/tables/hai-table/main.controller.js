(function ()
{
  ...
  angular.module('app.components.tables.HAI')
        .controller('HAIController', MainController);

    /** @ngInject */
    function MainController($http, $scope, $HAIFormAPI, $HAISearchFormAPI, $mdDialog, appConfig, $state, $stateParams, $timeout, $q, $log)
    {
      var folderPath = 'app/main/components/tables/hai-table/';
      var vm = this;
      ...
      $http.get(appConfig.apiUrl + 'HAIFiltersItems').then(function (response) {
      ...
      vm.addItem = function (event) {
        console.log(event);
        $state.go('app.ui_forms-HAITool');
      };

      vm.delete = function (event) {
        $mdDialog.show({
          clickOutsideToClose: true,
          controller: 'DelHAIAPIController',
          controllerAs: 'ctrl',
          focusOnOpen: false,
          targetEvent: event,
      ...
      vm.getItems= function () {
        ...
        vm.promise = $HAIFormAPI.items.get(vm.query, success).$promise;
      };
      ...
      function querySearch (query) {
        ...
        $http.get(appConfig.apiUrl + 'SearchHAIForm/' + finalQuery)
      ...
      $scope.loadGroups = function () {
        ...
        return $scope.searchItems.length ? null : $http.get(appConfig.apiUrl + 'getItemsForAdvanceSearchHAI').then(function (data) {
