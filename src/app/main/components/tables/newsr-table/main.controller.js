(function ()
{
  ...
  angular.module('app.components.tables.NEWSR')
        .controller('NEWSRController', MainController);

    /** @ngInject */
    function MainController($http, $scope, $NEWSRFormAPI, $NEWSRSearchFormAPI, $mdDialog, appConfig, $state, $stateParams, $timeout, $q, $log)
    {
      var folderPath = 'app/main/components/tables/NEWSR-table/';
      var vm = this;
      ...
      $http.get(appConfig.apiUrl + 'NEWSRFiltersItems').then(function (response) {
      ...
      vm.addItem = function (event) {
        console.log(event);
        $state.go('app.ui_forms-NEWSRTool');
      };

      vm.delete = function (event) {
        $mdDialog.show({
          clickOutsideToClose: true,
          controller: 'DelNEWSRAPIController',
          controllerAs: 'ctrl',
          focusOnOpen: false,
          targetEvent: event,
      ...
      vm.getItems= function () {
        ...
        vm.promise = $NEWSRFormAPI.items.get(vm.query, success).$promise;
      };
      ...
      function querySearch (query) {
        ...
        $http.get(appConfig.apiUrl + 'SearchNEWSRForm/' + finalQuery)
      ...
      $scope.loadGroups = function () {
        ...
        return $scope.searchItems.length ? null : $http.get(appConfig.apiUrl + 'getItemsForAdvanceSearchNEWSR').then(function (data) {
