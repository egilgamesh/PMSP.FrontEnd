(function ()
{
  ...
  angular.module('app.components.tables.water')
        .controller('WaterController', MainController);

    /** @ngInject */
    function MainController($scope, $WaterFormAPIOld, $mdDialog, appConfig, $state, $stateParams)
    {
      var folderPath = 'app/main/components/tables/water-table/';
      var vm = this;
      ...
      vm.getItems= function () {
        ...
        vm.promise = $WaterFormAPIOld.items.get(vm.query, success).$promise;
      };
