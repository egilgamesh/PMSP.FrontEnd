(function ()
{
  ...
  angular
    ...
    .controller('C2IGPAToolFormsController', FormsController);


  /** @ngInject */
  function FormsController(api, $stateParams, $mdDialog, $state, appConfig)
  {
    var vm = this;
    ...
    if ($stateParams.type === 'edit'){
      ...
      api.IGPA.C2ByID.get({'id': $stateParams.formId},
      ...
      api.IGPA.C2.save(submitData,
        ...
        function (response)
        {
          ...
          if(response.status === 'success'){
            ...
            $state.go('app.ui_forms-IGPATool.details', {id: $stateParams.id });
