(function ()
{
  ...
  angular
    ...
    .controller('HealthBSFormsController', FormsController);
  ...
  function FormsController(api, $stateParams, $mdDialog, $state, appConfig, FFSConstant)
  {
    ...
    if ($stateParams.type === 'edit'){
      ...
      api.ffs.healthBSById.get({'id': $stateParams.healthId},
    ...
    function sendForm(ev) {
      ...
      submitData.id = $stateParams.healthId;
      submitData.health_id = $stateParams.id;


      api.ffs.healthBS.save(submitData,
        ...
        function (response)
        {
          ...
          if(response.status === 'success'){
            ...
            $state.go('app.ui_forms-health.details', {id: $stateParams.id });
