(function ()
{
  ...
  angular
    ...
    .controller('MunicipalityBSFormsController', FormsController);
  ...
  function FormsController(api, $stateParams, $mdDialog, $state, appConfig, FFSConstant)
  {
    ...
    if ($stateParams.type === 'edit'){
      ...
      api.ffs.municipalityBSById.get({'id': $stateParams.municipalityId},
    ...
    function sendForm(ev) {
      ...
      api.ffs.municipalityBS.save(submitData,
