(function ()
{
  ...
  angular
    ...
    .controller('EducationBSFormsController', FormsController);
  ...
  function FormsController(api, $stateParams, $mdDialog, $state, appConfig, FFSConstant)
  {
    ...
    if ($stateParams.type === 'edit'){
      ...
      api.ffs.educationBSById.get({'id': $stateParams.educationId},
    ...
    function sendForm(ev) {
      ...
      submitData.id = $stateParams.educationId;
      submitData.education_id = $stateParams.id;


      api.ffs.educationBS.save(submitData,
        ...
        function (response)
        {
          ...
          if(response.status === 'success'){
            ...
            $state.go('app.ui_forms-education.details', {id: $stateParams.id });
