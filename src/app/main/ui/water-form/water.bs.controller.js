(function ()
{
  ...
  angular
    ...
    .controller('WaterBSFormsController', FormsController);
  ...
  function FormsController(api, $stateParams, $mdDialog, $state, appConfig, FFSConstant)
  {
    ...
    if ($stateParams.type === 'edit'){
      ...
      api.ffs.waterBSById.get({'id': $stateParams.waterId},
    ...
    function sendForm(ev) {
      ...
      submitData.id       = $stateParams.waterId;
      submitData.water_id = $stateParams.id;


      api.ffs.waterBS.save(submitData,
        ...
        function (response)
        {
          ...
          if(response.status === 'success'){
            ...
            $state.go('app.ui_forms-water.details', {id: $stateParams.id });
