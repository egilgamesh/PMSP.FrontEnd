(function ()
{
  ...
  angular
    ...
    .controller('NewCashForWorkBSFormsController', FormsController);
  ...
  function FormsController(api, $stateParams, $mdDialog, $state, appConfig, FFSConstant)
  {
    ...
    if ($stateParams.type === 'edit'){
      ...
      api.ffs.NewCashForWorkBSById.get({'id': $stateParams.formId},
    ...
    function sendForm(ev) {
      ...
      api.ffs.NewCashForWorkBS.save(submitData,
        ...
        function (response)
        {
          ...
          if(response.status === 'success'){
            ...
            $state.go('app.ui_forms-NewCashOfWork.details', {id: $stateParams.id });
